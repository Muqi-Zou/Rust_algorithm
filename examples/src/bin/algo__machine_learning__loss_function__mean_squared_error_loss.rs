...
pub use the_algorithms_rust::machine_learning::loss_function::mean_squared_error_loss as source;
pub use source::*;

fn main() {
    let mut cargo_args = vec!["test".to_string(), "--package".to_string(), "the_algorithms_rust".to_string()];
    cargo_args.push("--lib".to_string());
    cargo_args.push("machine_learning::loss_function::mean_squared_error_loss::".to_string());
