...
pub use the_algorithms_rust::data_structures::stack_using_singly_linked_list as source;
pub use source::*;

fn main() {
    let mut cargo_args = vec!["test".to_string(), "--package".to_string(), "the_algorithms_rust".to_string()];
    cargo_args.push("--lib".to_string());
    cargo_args.push("data_structures::stack_using_singly_linked_list::".to_string());
