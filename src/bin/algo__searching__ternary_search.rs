...
pub use the_algorithms_rust::searching::ternary_search as source;
pub use source::*;
...
fn main() {
    ...
    const TESTS: &[(&str, fn())] = &[
        ...
        ("search_two_elements_found_at_start", source::tests::search_two_elements_found_at_start as fn()),
        ("search_two_elements_found_at_end", source::tests::search_two_elements_found_at_end as fn()),
        ("search_two_elements_not_found_start", source::tests::search_two_elements_not_found_start as fn()),
        ("search_two_elements_not_found_end", source::tests::search_two_elements_not_found_end as fn()),
        ("search_three_elements_found_start", source::tests::search_three_elements_found_start as fn()),
        ("search_three_elements_found_middle", source::tests::search_three_elements_found_middle as fn()),
        ("search_three_elements_found_end", source::tests::search_three_elements_found_end as fn()),
        ("search_three_elements_not_found_start", source::tests::search_three_elements_not_found_start as fn()),
        ("search_three_elements_not_found_end", source::tests::search_three_elements_not_found_end as fn()),
